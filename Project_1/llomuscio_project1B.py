...
def plot_regular(data,polydeg, debug = False):
...
def interpolation(data, column1, column2, value_inp):
...
parser.add_argument('activS', action = "store_true")
parser.add_argument('activP', action = "store_true")
parser.add_argument('activR', action = "store_true")
parser.add_argument('activI', action = "store_true")
...
if args.activI == True:
    ...
    interpolation(our_dictionary, column1=args.interpolation[0],column2=args.interpolation[1],value_inp=args.interpolation[2])
else : 
    print("Interpolate is inactive")
#value_inp must be an int

#Only Plotting 
if args.activR is == True:
